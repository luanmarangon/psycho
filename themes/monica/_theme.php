            ...
            <div class="row s-header__inner width-sixteen-col">
                ...
                <div class="s-header__block">
                    <div class="s-header__logo">
                        <a class="logo" href="<?= url("/"); ?>">
                            <img src="<?= theme("/assets/images/logo.svg"); ?>" alt="Homepage">
                        </a>
                    </div>
                ...
                <nav class="s-header__nav">
                    ...
                    <div class="s-header__contact">
                        <a href="<?= url("/contato"); ?>" class="btn btn--primary s-header__contact-btn">Vamos trabalhar juntos</a>
            ...
            <div class="row row-x-center text-center">
                <div class="column xl-8 lg-12">
                    ...
                    <div class="s-cta__content">
                        ...
                        <p class="lead">
                            "Inicie uma vida mais equilibrada hoje. Descubra bem-estar e autoconhecimento com uma consulta. Investir em si mesmo é o primeiro passo para construir um futuro satisfatório. Marque agora e comece a transformação pessoal. Sua prioridade é seu bem-estar. Dê o primeiro passo para uma versão mais positiva de você mesmo
                        </p>
                        <a href="<?= url("/contato"); ?>" class="btn btn--primary">Vamos trabalhar juntos</a>
                    </div>
            ...
            <div class="row s-footer__content">
                ...
                <div class="column xl-3 lg-6 md-12 s-footer__block s-footer__site-links">
                    ...
                    <ul class="link-list">
                        ...
                        <li><a href="<?= url("/politica-privacidade"); ?>">Politica de Privacidade</a></li>
                    </ul>
                </div>
